...
public class DriveCountRequest implements IRequest {
    private final String path;
    private final String query;

    DriveCountRequest(final String path, final String query) {
        this.path = path;
        this.query = query;
    }
    ...
    public static class Builder {
        ...
        public DriveCountRequest build() {
            ...
            return new DriveCountRequest(path, query);
        }
