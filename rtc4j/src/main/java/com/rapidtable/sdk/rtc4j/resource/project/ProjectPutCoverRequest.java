...
public class ProjectPutCoverRequest implements IPutObjectRequest {
    private final String path;
    private final String boundary;
    private final HttpRequest.BodyPublisher publisher;

    ProjectPutCoverRequest(final String path, final String boundary,
    ...
    public static class Builder {
        ...
        public ProjectPutCoverRequest build() throws IOException {
            final var path = PathConfig.ROOT + PathConfig.WORKSPACE + String.format("/%s", workspaceId) +
                PathConfig.PROJECTS + String.format("/%s", projectId) + PathConfig.OBJECTS;
            ...
            try (final var os = new ByteArrayOutputStream()) {
                ...
                return new ProjectPutCoverRequest(path, boundary, publisher);
            }
        }
        ...
        private String encodedFileName() {
            return URLEncoder
                .encode(file.getFileName().toString(), UTF_8)
                .replace("+", "%20");
        }
    }
}
