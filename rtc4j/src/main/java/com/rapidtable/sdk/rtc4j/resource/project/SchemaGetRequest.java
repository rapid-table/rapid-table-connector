...
public class SchemaGetRequest implements IRequest {
    private final String path;
    private final String query;

    SchemaGetRequest(final String path, final String query) {
        this.path = path;
        this.query = query;
    }
    ...
    public static class Builder {
        ...
        public SchemaGetRequest build() {
            ...
            return new SchemaGetRequest(path, null);
        }
