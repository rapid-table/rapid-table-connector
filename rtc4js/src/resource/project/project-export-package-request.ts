...
export class ProjectExportPackageRequest implements IRequest {
  constructor(
    public path: string,
...
class Builder {
  ...
  public build(): ProjectExportPackageRequest {
    const path =
      PathConfig.ROOT +
    ...
    return new ProjectExportPackageRequest(path, params);
  }
