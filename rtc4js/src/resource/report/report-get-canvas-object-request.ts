...
export class ReportGetCanvasObjectRequest implements IRequest {
...
class Builder {
    ...
    public build(): ReportGetCanvasObjectRequest {
        if (!this._path) {
            throw new Error('IllegalArgumentException');
        }
        return new ReportGetCanvasObjectRequest(this._path, {});
    }

    public target(value: unknown): Builder {
        if (value !== null && typeof value === 'string') {
            const matcher = PathConfig.REPORT_CANVAS_OBJECT_PATH_PATTERN.exec(value);
